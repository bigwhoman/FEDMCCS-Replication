...
import os
os.chdir('/home/user01/flower/baselines/flwr_baselines/publications/fedavg_mnist/')
...
import client, utils, client_selector, runner
...
def main(cfg: DictConfig) -> None:
    ...
    # Start simulation
    history = runner.start_simulation(
        client_fn=client_fn,
        num_clients=cfg.num_clients,
        config=fl.server.ServerConfig(num_rounds=cfg.num_rounds),
        strategy=strategy,
        client_manager=client_selector.SimpleClientManager()
    )
