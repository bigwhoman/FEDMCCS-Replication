...
RESOURCES = [
    ...
    (1, 0.15, 250, 100, 1024 * 512),
    (1, 0.25, 150, 100, 1024 * 512),
    (1, 0.001, 150, 100, 1024 * 512),
    (1, 0.35, 150, 100, 1024 * 512),
    (1, 0.01, 150, 100, 1024 * 512),
    (1, 0.5, 150, 100, 1024 * 512),
    (1, 0.01, 150, 100, 1024 * 512),
    (1, 0.1, 150, 100, 1024 * 512),
      (1, 1, 200, 0, 1024 * 1024),
     (1, 0.75, 500, 0, 1024 * 1024),
